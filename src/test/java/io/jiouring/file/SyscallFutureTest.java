...
class SyscallFutureTest {
    ...
    void completeWithPositiveResult() throws IOException {
        SyscallFuture future = new SyscallFuture();
        future.reset((byte) 1);
        future.complete(42);
    ...
    @Test
    void resetClearsState() throws IOException {
        SyscallFuture future = new SyscallFuture();
        future.reset((byte) 1);
        future.complete(42);
        assertEquals(42, future.join());
        ...
        future.reset((byte) 2);
        future.complete(100);
        assertEquals(100, future.join());
    }

    @Test
    void resetAllowsNewHandler() {
        SyscallFuture future = new SyscallFuture();
        future.reset((byte) 1);
        ...
        future.onComplete((r, e) -> called.set(r));
        future.complete(42);
